...
# %%
files_list = [file for file in list_gcs_files(bucket_name, prefix_in_bucket) if ".parquet" in file]
...
for file in files_list:
    ...
    columns_not_in_intersection=required_columns.symmetric_difference(set(file_df.columns))
